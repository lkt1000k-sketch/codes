...
var aesEcbPkcs5Enc = function (str, key) {
  return CryptoJS.enc.Base64.stringify(CryptoJS.AES.encrypt(CryptoJS.enc.Utf8.parse(str), CryptoJS.enc.Utf8.parse(key.padEnd(32, '0')), {
...
function findByCurrentUser(email) {
  ...
  $httpClient.post(params, function (error, response, data) {
    if (error != "nil") {
      ...
      $notification.post("SkyRing", "❌ 失败 /Hour Token Failed", error + " " + response);
    } else {
